...
@CompoundIndex(name = "unique_tracker_constraint", def = "{'userId' : 1, 'habitId': 1, 'date': 1}", unique = true)
public class TrackerController {
    private final TrackerService trackerService;

    @PostMapping("/addTracker")
    Mono<ResponseEntity<Tracker>> addTracker (@Valid @RequestBody Tracker tracker){
